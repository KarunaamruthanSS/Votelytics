...
import { Loader2, Trophy, AlertTriangle, IndianRupee, GraduationCap, Users } from 'lucide-react';
...
const parseEducation = (edu: string) => {
  ...
  if (e.includes('doctorate')) return 5;
  if (e.includes('post graduate')) return 4;
  if (e.includes('graduate')) return 3;
  if (e.includes('12th')) return 2;
  if (e.includes('10th')) return 1;
  return 0;
};
...
export default function ConstituencyPage() {
  ...
  const { winner, district, constituency_no } = useMemo(() => {
    ...
    return { winner: best, district, constituency_no };
  }, [candidates]);
  ...
  return (
    <div className="container mx-auto px-4 max-w-6xl space-y-8">
      {/* Header Info */}
      <div className="bg-white dark:bg-slate-900 border rounded-2xl p-6 shadow-sm flex justify-between items-center flex-wrap gap-4">
        <div>
          ...
          <div className="relative z-10">
            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
              <div>
                ...
                <div className="mt-4 flex gap-6 mt-4">
